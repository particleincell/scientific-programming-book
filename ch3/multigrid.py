...
def MGsolve(phi,b):
    ...
    for it in range(10001):
        ...
        if (plotting and it % int(25/inner_its) == 0):
            pl.plot(x,phi)
#            print("it: %d, norm: %g"%(it, norm))
...
op_mg = MGsolve(phi,b)
time_mg = time.perf_counter() -t3

print("Operation count ratio (GS/MG): %g"%(op_gs/op_mg))

print("Timing ration (GS/MG): %g"%((time_gs/time_mg)))
